...
//     AssertAreEqual(sizeof(Chunk), BytesPerBlock * ChunkSize,
...
//     BlockIndex index = 8;
//     chunk.Blocks[index].Type = 1u;
//     uint16_t type = chunk.Blocks[index].Type;
//
